...
static func get_quest_defs() -> Dictionary:
	...
	"wood_gathering": {
		...
		"description": "The village needs timber for patching roofs. Bring 20 wood to any villager.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "wood", "count": 20}],
		"reward_items": [{"id": "wooden_planks", "count": 5}],
		"reward_gold": 50,
		"reward_reputation": 5,
		"reward_xp": 25,
		"prerequisite_ids": [],
	...
	"stone_path": {
		...
		"description": "The paths through town are muddy. Gather 15 stone for paving.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "stone", "count": 15}],
		"reward_items": [{"id": "stone", "count": 10}],
		"reward_gold": 40,
		"reward_reputation": 5,
		"reward_xp": 20,
		"prerequisite_ids": [],
	...
	"flower_pots": {
		...
		"description": "Let's brighten the streets! Bring 5 flowers to decorate the town.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "flower", "count": 5}],
		"reward_items": [{"id": "flower", "count": 3}],
		"reward_gold": 30,
		"reward_reputation": 8,
		"reward_xp": 15,
		"prerequisite_ids": [],
	...
	"baker_fruit": {
		...
		"description": "I'm baking pies but I'm low on fruit. Bring me 10 berries!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "berry", "count": 10}],
		"reward_items": [{"id": "bread", "count": 3}],
		"reward_gold": 60,
	...
	"baker_wheat": {
		...
		"description": "I need a fresh batch of ingredients. Bring 15 berries for the bakery — I'll make special jam-filled pastries!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "berry", "count": 15}],
		"reward_items": [{"id": "bread", "count": 3}],
		"reward_gold": 100,
	...
	"chef_mushroom_soup": {
		...
		"description": "The daily special needs wild mushrooms! Collect 8 mushrooms for the kitchen.",
		"req_type": RequirementType.COLLECT_ITEMS,
		"requirements": [{"id": "mushroom", "count": 8}],
		"reward_items": [{"id": "mushroom_stew", "count": 2}],
		"reward_gold": 80,
		"reward_reputation": 10,
		"reward_xp": 35,
		"prerequisite_ids": [],
	...
	"chef_feast": {
		...
		"giver_role": TownResidentNPC.Role.CHEF,
		"title": "Town Feast",
		"description": "We're preparing a grand feast! Bring 3 hearty_stew dishes to serve everyone.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "hearty_stew", "count": 3}],
		"reward_items": [{"id": "golden_soup", "count": 2}],
		"reward_gold": 150,
	...
	"innkeeper_wood": {
		...
		"description": "I'm building new tables for the tavern. Bring me 25 wood!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "wood", "count": 25}],
		"reward_items": [{"id": "bread", "count": 5}],
		"reward_gold": 100,
	...
	"innkeeper_ale": {
		...
		"giver_role": TownResidentNPC.Role.INNKEEPER,
		"title": "Berry Brew",
		"description": "I'm experimenting with a new berry brew recipe. Bring me 10 berries for the brew!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "berry", "count": 10}],
		"reward_items": [{"id": "berry_juice", "count": 5}],
		"reward_gold": 120,
		"reward_reputation": 15,
		"reward_xp": 45,
		"prerequisite_ids": [],
	...
	"blacksmith_copper": {
		...
		"title": "Copper Rush",
		"description": "The forge needs copper for new tools. Mine 10 copper_ore and bring it here.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "copper_ore", "count": 10}],
		"reward_items": [{"id": "copper_ingot", "count": 3}],
		"reward_gold": 100,
		"reward_reputation": 10,
		"reward_xp": 40,
		"prerequisite_ids": [],
	...
	"blacksmith_iron": {
		...
		"giver_role": TownResidentNPC.Role.BLACKSMITH,
		"title": "Iron Tools",
		"description": "I need iron to forge stronger tools. Bring 8 Iron Ore and 5 Coal.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "iron_ore", "count": 8}, {"id": "coal", "count": 5}],
		"reward_items": [{"id": "iron_ingot", "count": 3}],
		"reward_gold": 150,
		"reward_reputation": 15,
		"reward_xp": 60,
	...
	"blacksmith_arms": {
		...
		"giver_role": TownResidentNPC.Role.BLACKSMITH,
		"title": "For the Guard",
		"description": "The town needs arms! Deliver 3 Steel Ingots for crafting weapons.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "steel_ingot", "count": 3}],
		"reward_items": [{"id": "tool_upgrade_kit", "count": 1}],
		"reward_gold": 250,
	...
	"shopkeep_rare_goods": {
		...
		"title": "Rare Finds",
		"description": "Customers want exotic goods! Bring me 3 Diamonds from the mines.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "diamond_gem", "count": 3}],
	...
	"shopkeep_stock_up": {
		...
		"description": "I'm running low on basic supplies. Bring 10 Wooden Planks and 10 Stone.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "wooden_planks", "count": 10}, {"id": "stone", "count": 10}],
		"reward_items": [{"id": "compost", "count": 5}],
		"reward_gold": 80,
		"reward_reputation": 8,
		"reward_xp": 30,
		"prerequisite_ids": [],
	...
	"scholar_crops": {
		...
		"reward_items": [{"id": "growth_booster", "count": 3}],
		"reward_gold": 150,
		"reward_reputation": 20,
		"reward_xp": 100,
		"prerequisite_ids": [],
	...
	"scholar_rare_flower": {
		...
		"giver_role": TownResidentNPC.Role.SCHOLAR,
		"title": "Exotic Flora",
		"description": "I've heard tales of rare flowers. Bring me 10 flowers of any variety!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "flower", "count": 10}],
		"reward_items": [{"id": "quality_compost", "count": 3}],
		"reward_gold": 100,
		"reward_reputation": 15,
		"reward_xp": 50,
		"prerequisite_ids": [],
	...
	"stablehand_fiber": {
		...
		"description": "The stables need fresh bedding. Bring 20 wood shavings — I'll use them as animal bedding.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "wood", "count": 20}],
		"reward_items": [{"id": "feather", "count": 5}],
		"reward_gold": 60,
		"reward_reputation": 10,
		"reward_xp": 25,
		"prerequisite_ids": [],
	...
	"stablehand_feed": {
		...
		"giver_role": TownResidentNPC.Role.STABLEHAND,
		"title": "Animal Feed",
		"description": "The animals are hungry! Bring 15 berries to feed them.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "berry", "count": 15}],
		"reward_items": [{"id": "egg", "count": 5}],
		"reward_gold": 90,
		"reward_reputation": 12,
		"reward_xp": 35,
		"prerequisite_ids": [],
	...
	"visitor_explore_cove": {
		...
		"title": "Explore the Eastern Cove",
		"description": "I heard there's a hidden cove on the east side. Explore it and tell me what you find!",
		"req_type": RequirementType.COLLECT_ITEMS,
		"requirements": [{"id": "shell", "count": 3}],
		"reward_items": [{"id": "pearl", "count": 2}],
		"reward_gold": 60,
		"reward_reputation": 5,
		"reward_xp": 30,
		"prerequisite_ids": [],
	...
	"visitor_fish_catch": {
		...
		"giver_source": "visitor",
		"title": "Fresh Catch",
		"description": "I'm a traveling angler and I'd love to try the local catch! Bring me 3 Raw Fish from the waters here.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "raw_fish", "count": 3}],
		"reward_items": [{"id": "gold_nugget", "count": 3}],
		"reward_gold": 80,
		"reward_reputation": 5,
		"reward_xp": 35,
		"prerequisite_ids": [],
	...
	"visitor_tour_guide": {
		...
		"description": "I'm new to this island! Show me some beautiful flowers — pick 5 flowers from around the island.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "flower", "count": 5}],
		"reward_items": [{"id": "berry", "count": 8}],
		"reward_gold": 40,
		"reward_reputation": 5,
		"reward_xp": 20,
		"prerequisite_ids": [],
	...
	"visitor_trade_goods": {
		...
		"description": "I'm a merchant looking for exotic items. Bring me 3 any_gem from your travels and I'll make it worth your while!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "any_gem", "count": 3}],
		"reward_items": [{"id": "gold_ingot", "count": 1}],
		"reward_gold": 200,
		"reward_reputation": 10,
		"reward_xp": 80,
		"prerequisite_ids": [],
	...
	"visitor_scenic_spot": {
		...
		"giver_source": "visitor",
		"title": "Scenic Views",
		"description": "I've heard the island has stunning views. Bring me a mushroom from a high place — proof you've explored!",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "mushroom", "count": 5}],
		"reward_items": [{"id": "feather", "count": 5}],
		"reward_gold": 50,
		"reward_reputation": 5,
		"reward_xp": 25,
	...
	"visitor_help_vendor": {
		...
		"description": "I'm a traveling vendor and I'm running low on supplies. Could you bring me 10 wood and 5 stone for my cart repairs?",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "wood", "count": 10}, {"id": "stone", "count": 5}],
	...
	"slay_sporelings": {
		...
		"giver_source": "any",
		"title": "Pest Control",
		"description": "Sporelings have been spotted near the farms! Defeat 5 of them to protect the crops.",
		"req_type": RequirementType.KILL_ENEMIES,
		"requirements": [{"id": "SporelingEnemy", "count": 5}],
		"reward_items": [{"id": "mushroom", "count": 10}],
		"reward_gold": 120,
		"reward_reputation": 15,
		"reward_xp": 80,
		"prerequisite_ids": [],
	...
	"shadow_hound_hunt": {
		...
		"description": "Shadow Hounds are prowling at night. Defeat 3 of them to keep the town safe.",
		"req_type": RequirementType.KILL_ENEMIES,
		"requirements": [{"id": "ShadowHound", "count": 3}],
		"reward_items": [{"id": "health_potion", "count": 2}],
		"reward_gold": 200,
		"reward_reputation": 20,
		"reward_xp": 100,
		"prerequisite_ids": [],
...
static func get_quest_dialogue(quest_id: String) -> Dictionary:
	var dialogues := {
		"wood_gathering": {
			"intro": "Ah, a strong pair of hands! The roofs are leaking again. Could you gather 20 wood for repairs?",
		...
		"stone_path": {
			"intro": "The paths are a muddy mess when it rains. Could you haul 15 stone for paving?",
		...
		"flower_pots": {
			"intro": "The town could use some color! Would you pick 5 flowers to brighten the streets?",
		...
		"baker_fruit": {
			"intro": "I'm in the middle of baking, but I'm short on fruit! Could you bring me 10 berries?",
		...
		"baker_wheat": {
			"intro": "I'm in need of fresh fruit for my jam-filled pastries! Could you bring me 15 berries?",
			"accept": "Wonderful! The pastries will be divine!",
			"decline": "Perhaps another day.",
			"progress": "The bakery is quiet without fresh fruit...",
			"complete": "Perfect berries! Fresh bread for you as a reward!",
		},
		"chef_mushroom_soup": {
			"intro": "The daily special is mushroom soup, but I'm out of mushrooms! Gather 8 for me?",
			"accept": "Perfect! The soup will be legendary!",
			"decline": "I'll have to change the menu then...",
			"progress": "My soup pot is still empty...",
			"complete": "Beautiful mushrooms! Take this mushroom_stew for your journey!",
		},
		"chef_feast": {
			"intro": "We're preparing a grand town feast! Could you contribute 3 hearty_stew dishes?",
		...
		"innkeeper_wood": {
			"intro": "I'm building new tables for the tavern. Bring me 25 wood and I'll reward you well!",
		...
		"innkeeper_ale": {
			"intro": "I'm experimenting with a new berry brew recipe. Bring me 10 fresh berries!",
			"accept": "The brews will be flowing!",
			"decline": "The kegs will stay dry then...",
			"progress": "The brew is flat without those berries...",
			"complete": "Perfect berries! Have some berry_juice as thanks!",
		},
		"blacksmith_copper": {
			"intro": "The forge is cold because I'm out of copper. Mine 10 copper_ore for me?",
		...
		"blacksmith_iron": {
			"intro": "Ready for real work? Bring me 8 iron_ore and 5 coal. I'll make you something special.",
		...
		"blacksmith_arms": {
			"intro": "The town guard needs proper weapons. Bring me 3 steel_ingot and I'll craft you a blacksmith component kit!",
		...
		"shopkeep_rare_goods": {
			"intro": "Wealthy customers want rare gems! Bring me 3 diamond_gem from the deep mines!",
		...
		"shopkeep_stock_up": {
			"intro": "I'm running low on basic supplies. Can you bring 10 wooden_planks and 10 stone?",
		...
		"scholar_rare_flower": {
			"intro": "I'm collecting specimens for my herbarium. Bring me 10 flowers of any kind!",
		...
		"stablehand_fiber": {
			"intro": "The animals need fresh bedding. Can you gather 20 wood for shavings?",
		...
		"stablehand_feed": {
			"intro": "The animals are hungry! Bring 15 berries to feed them, will you?",
		...
		"slay_sporelings": {
			"intro": "Dangerous sporelings have been seen near the farms! Could you defeat 5 of them?",
		...
		"shadow_hound_hunt": {
			"intro": "Shadow Hounds are terrorizing the town at night! Defeat 3 of them for us!",
		...
		"visitor_explore_cove": {
			"intro": "I heard there's a hidden cove with shimmering shells on the eastern shore! Could you bring me 3 shells as proof you found it?",
			"accept": "Excellent! I can't wait to see what you find!",
			"decline": "No worries, I'll explore it myself sometime.",
			"progress": "Been to that eastern cove yet? The tides should be low!",
			"complete": "These are gorgeous! Here, take these pearls I found on my travels!",
		},
		"visitor_fish_catch": {
			"intro": "I've heard the fishing here is legendary! Could you catch me 3 raw_fish so I can taste the local flavor?",
		...
		"visitor_tour_guide": {
			"intro": "I'm new to this island — I've heard the flowers are stunning! Pick 5 flowers and show me the best spots!",
		...
		"visitor_trade_goods": {
			"intro": "I'm a trader looking for rare gems! Bring me 3 gems and I'll make you a deal you can't refuse!",
			"accept": "A merchant's instinct tells me you'll find something good!",
			"decline": "Ah, not a gem hunter? Well, another time perhaps.",
			"progress": "The market waits for no one — any gems yet?",
			"complete": "Superb quality! A gold ingot for your troubles, friend!",
		},
		"visitor_scenic_spot": {
			"intro": "I'm documenting every scenic spot on this island! Bring me 5 mushrooms photo evidence of your adventures!",
			"accept": "The island's beauty must be shared!",
			"decline": "Maybe next time you're out exploring.",
			"progress": "Explored any good spots lately?",
			"complete": "These must have come from a beautiful forest! Have some feathers from my hat!",
		},
		"visitor_help_vendor": {
			"intro": "My cart took a beating on the road! I need 10 wood and 5 stone for repairs. Help me out?",
...
func get_quest_progress_text(quest_id: String) -> String:
	...
	for req: Dictionary in reqs:
		...
		var display_name: String = item_data.display_name if item_data else req_id.capitalize()
