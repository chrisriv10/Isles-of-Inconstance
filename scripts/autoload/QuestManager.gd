...
static func get_quest_defs() -> Dictionary:
	...
	# ── Fishing & coastal quests (v4) ─────────────────────────────────────
	"chef_fresh_catch": {
		"id": "chef_fresh_catch",
		"giver_role": TownResidentNPC.Role.CHEF,
		"title": "Angler's Special",
		"description": "I'm trying a new fish dish for the menu! Bring me 5 Raw Fish and 2 Perch from the waters.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "raw_fish", "count": 5}, {"id": "perch", "count": 2}],
		"reward_items": [{"id": "berry_juice", "count": 2}],
		"reward_gold": 140,
		"reward_reputation": 12,
		"reward_xp": 70,
		"prerequisite_ids": [],
	...
	"scholar_ocean_catalog": {
		"id": "scholar_ocean_catalog",
		"giver_role": TownResidentNPC.Role.SCHOLAR,
		"title": "Tales of the Deep",
		"description": "I'm documenting every creature of these waters. Bring me one Carp, one Perch, one Salmon, and one Trout for my catalog.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "carp", "count": 1}, {"id": "perch", "count": 1}, {"id": "salmon", "count": 1}, {"id": "trout", "count": 1}],
	...
	# ── Mining & smithing quests (v4) ─────────────────────────────────────
	"blacksmith_mining_crew": {
		"id": "blacksmith_mining_crew",
		"giver_role": TownResidentNPC.Role.BLACKSMITH,
		"title": "Crew's Tools",
		"description": "The miners need reinforced tools. Bring me 2 Iron Ingots and 5 Silver Ore for the forge.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "iron_ingot", "count": 2}, {"id": "silver_ore", "count": 5}],
		"reward_items": [{"id": "silver_ingot", "count": 2}],
		"reward_gold": 180,
		"reward_reputation": 15,
		"reward_xp": 80,
		"prerequisite_ids": ["blacksmith_iron"],
	...
	# ── Foraging quests (v4) ──────────────────────────────────────────────
	"shopkeep_forest_haul": {
		"id": "shopkeep_forest_haul",
		"giver_role": TownResidentNPC.Role.SHOPKEEP,
		"title": "Forest Bounty",
		"description": "Shoppers love wild goods! Bring me 20 Wood and 10 Mushrooms for the market stall.",
		"req_type": RequirementType.DELIVER_ITEMS,
		"requirements": [{"id": "wood", "count": 20}, {"id": "mushroom", "count": 10}],
		"reward_items": [{"id": "wooden_planks", "count": 8}],
		"reward_gold": 130,
		"reward_reputation": 10,
		"reward_xp": 60,
	...
	# ── Visitor / exploration quests (v4) ─────────────────────────────────
	"visitor_cave_guard": {
		"id": "visitor_cave_guard",
		"giver_role": -1,
		"giver_source": "visitor",
		"title": "Cave Patrol",
		"description": "I heard the mines are crawling with bats! Could you clear out 10 of them before I go down there?",
		"req_type": RequirementType.KILL_ENEMIES,
		"requirements": [{"id": "CaveBat", "count": 10}],
		"reward_items": [{"id": "gold_nugget", "count": 6}],
		"reward_gold": 220,
		"reward_reputation": 18,
		"reward_xp": 110,
		"prerequisite_ids": [],
	...
	"visitor_moonlight_hunt": {
		"id": "visitor_moonlight_hunt",
		"giver_role": -1,
		"giver_source": "visitor",
		"title": "Moonlight Hunter",
		"description": "A traveling knight wants to prove herself. Help her take down 6 Stone Golems lurking in the deep caves.",
		"req_type": RequirementType.KILL_ENEMIES,
		"requirements": [{"id": "StoneGolem", "count": 6}],
		"reward_items": [{"id": "health_potion", "count": 4}, {"id": "iron_ingot", "count": 2}],
		"reward_gold": 320,
		"reward_reputation": 25,
		"reward_xp": 160,
		"prerequisite_ids": [],
...
static func get_quest_dialogue(quest_id: String) -> Dictionary:
	var dialogues := {
		...
		"chef_fresh_catch": {
			"intro": "I'm trying a brand new fish dish for the menu! Could you bring me 5 Raw Fish and 2 Perch?",
			"accept": "Splendid! The kitchen will smell amazing!",
			"decline": "I'll stick to the mushroom soup for now.",
			"progress": "The pan is hot and waiting... any fresh fish yet?",
			"complete": "Beautiful, fresh fish! Enjoy some berry juice on the house!",
		},
		"scholar_ocean_catalog": {
			"intro": "I'm documenting every creature of these waters. Bring me one Carp, Perch, Salmon, and Trout for my catalog!",
			"accept": "Excellent! Your name will grace my field notes!",
			"decline": "Do stop by if you change your mind.",
			"progress": "My specimen jars are still empty...",
			"complete": "Magnificent specimens! Here's something to keep you healthy!",
		},
		"blacksmith_mining_crew": {
			"intro": "The miners need reinforced tools for the deep shafts. Bring me 2 Iron Ingots and 5 Silver Ore!",
			"accept": "Good lad! The forge is hot and ready!",
			"decline": "The miners will have to make do then.",
			"progress": "The forge fires still burn... got those materials yet?",
			"complete": "Prime forging material! Take these silver ingots!",
		},
		"shopkeep_forest_haul": {
			"intro": "Shoppers love wild goods around here! Bring me 20 Wood and 10 Mushrooms for my stall.",
			"accept": "Wonderful! The stall will be the talk of the town!",
			"decline": "A shame, but the shelves will survive.",
			"progress": "The shelves are still bare... any wild goods yet?",
			"complete": "Splendid haul! Have some planks to take home!",
		},
		"visitor_cave_guard": {
			"intro": "I heard the mines are crawling with bats! Clear out 10 of them before I risk a trip down there?",
			"accept": "Brave soul! I'll wait by the entrance.",
			"decline": "I'll find another guide then.",
			"progress": "The caves are still fluttering with wings...",
			"complete": "The caves are quiet now. Take these gold nuggets!",
		},
		"visitor_moonlight_hunt": {
			"intro": "A knight needs witnesses for her hunt. Help her take down 6 Stone Golems in the deep caves!",
			"accept": "Then we ride at dawn... well, into the caves!",
			"decline": "The golems can wait, I suppose.",
			"progress": "The golems still rumble in the dark depths...",
			"complete": "A glorious hunt! Take these potions and ingots!",
		},
	}
