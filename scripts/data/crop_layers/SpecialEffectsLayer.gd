...
func _apply_glow(image: Image, _center_x: int, _center_y: int) -> void:
...
func _apply_sparkle(image: Image, _center_x: int, _center_y: int) -> void:
	var width := image.get_width()
	var height := image.get_height()
...
func _apply_shadow(image: Image, _center_x: int, _center_y: int) -> void:
	var width := image.get_width()
	var height := image.get_height()
...
func _apply_outline(image: Image, _center_x: int, _center_y: int) -> void:
